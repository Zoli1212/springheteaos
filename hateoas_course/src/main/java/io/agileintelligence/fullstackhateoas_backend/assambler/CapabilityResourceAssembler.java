package io.agileintelligence.fullstackhateoas_backend.assambler;
...
public class CapabilityResourceAssembler implements ResourceAssembler<Capability, Resource<Capability>> {
    ...
    public Resource<Capability> toResource(Capability entity){
        return new Resource<>(entity,
                ...
                linkTo(methodOn(CapabilityController.class).deleteCapability(entity.getId())).withRel("getThisCapability"),
