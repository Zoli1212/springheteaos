...
public class CapabilityService {
    ...
    public Capability updateCapability(Long id, Capability capability){
        return capabilityRepository.findById(id).map(
                ...
                }).orElseGet(() -> {return capabilityRepository.save(capability);
                });
    ...
    public void deleteCapability(Long id){
        ...
        capabilityRepository.delete(capabilityRepository.findById(id).orElseThrow(()-> new CapabilityException("Capability with ID : "
        +id+" Not found")));
    }
